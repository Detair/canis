...
### Added
- OpenAPI/Swagger UI documentation for all 163 API endpoints — enable with `cargo build --features swagger` and visit `/api/docs` to browse interactive API documentation with JWT auth support, grouped by tag (#171)
